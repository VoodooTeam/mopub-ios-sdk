...
- (void)trackImpressionForConfiguration:(MPAdConfiguration *)configuration
{
    ...
    [VSAnalytics pixelTracker:@"IMPRESSION" impUrls:configuration.impressionTrackingURLs clickUrl: nil];
}
...
- (void)trackClickForConfiguration:(MPAdConfiguration *)configuration
{
    ...
    [VSAnalytics pixelTracker:@"CLICK" impUrls:nil clickUrl:configuration.clickTrackingURL];
}
